...
int main()
{
	...
	// 创建一个助教实例  
	// 注意：这里不能直接使用zhengLi对象作为adviser，因为graduate需要一个teacher类型的拷贝  
	// 所以我们创建一个新的teacher对象，它的数据与zhengLi相同  
	teacher advisorCopy("Zheng Li", "1001", "Female", Date(1978, 1, 1), "1234567890", "professor", "CST"); // 假设advisor的个人信息和教师相同  
